#bước 1: source myenv/bin/activate
#bước 2: 
...
# Thực hiện một số công việc hay sự kiện cần đo thời gian
        ...
        if rect!=None:
            ...
            if eye_aspect_ratio < EYE_DROWSINESS_THRESHOLD:
                ...
                if time.time()-eye_start_time >= EYE_DROWSINESS_INTERVAL:
                    cv2.putText(frame, "BAN DANG NHAM MAT!", (10, 30),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                    play_alert_sound('thongbao.mp3')  # Phát âm thanh thông báo
            ...
            if (eye_initialized==False) & (mouth_initialized==False) & (distracton_initialized==False):
                ...
                if time.time()-normal_start_time >= NORMAL_INTERVAL:
                        cv2.putText(frame, "BINH THUONG!", (10, 30),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                        print('Normal')
            else:
            ...
            if time.time()- distracton_start_time> DISTRACTION_INTERVAL:
                ...
                cv2.putText(frame, "BAN DANG MAT TAP TRUNG", (10, 30),
                            cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                play_alert_sound('thongbao.mp3')  # Phát âm thanh thông báo
